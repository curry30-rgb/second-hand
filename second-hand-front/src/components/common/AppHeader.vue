<template>
    <div class="header">
        <div class="header-container">
            <div class="app-name" style="display: flex; justify-content: space-between; align-items: center">
                <router-link to="/" style="display: flex; align-items: center">
                    <img src="../../logo/logo.png" alt="LOGO" style="width: 40px; margin-right: 5px" />
