<template>
    <div class="main-border">
        <el-table :data="Order" stripe style="width: 100%; color: #5a5c61">
            ...
            <el-table-column prop="idleItem.idleName" label="二手物品名称" show-overflow-tooltip> </el-table-column>
            ...
            <el-table-column label="支付方式" width="100" show-overflow-tooltip>
                <template slot-scope="scope">
                    <span v-if="scope.row.orderStatus === 1 || scope.row.orderStatus === 2 || scope.row.orderStatus === 3">{{
