            ...
            <div class="idle-details-container">
                <div class="details-header">
                    ...
                    <div class="details-header-buy" :style="'width:' + (isMaster ? '150px;' : '280px;')">
                        ...
                        <el-button v-if="!isMaster && idleItemInfo.idleStatus === 1" type="danger" plain @click="buyButton(idleItemInfo)"
                            >立即购买</el-button
                        >
                        <el-button
                ...
                <div class="message-container" id="replyMessageLocation">
                    ...
                    <div class="message-send">
                        <div v-if="isReply" style="padding-bottom: 10px">
                            <el-button type="info" @click="cancelReply"
                                >回复：{{ replyData.toMessage }} @{{ replyData.toUserNickname }} <i class="el-icon-close el-icon--right"></i
                            ></el-button>
                        </div>
                        <el-input
                            type="textarea"
...
import AppBody from '../common/AppPageBody';
import AppFoot from '../common/AppFoot';
    ...
    methods: {
        ...
        replyMessage(index) {
            ...
            this.replyData.toMessage =
                this.messageList[index].content.substring(0, 10) + (this.messageList[index].content.length > 10 ? '...' : '');
