            ...
            <el-container>
                <div class="mainBody" background-color="#3a8ee6">
                    ...
                    <el-main>
                        ...
                        <Advertise v-if="mode == 4"></Advertise>
                        <dataAnalysis v-if="mode == 5"></dataAnalysis>
                    </el-main>
                </div>
            </el-container>
        </el-container>
...
import IdleGoods from '../common/IdleGoods';
import orderList from '../common/orderList.vue';
import userList from '../common/userList.vue';
import dataAnalysis from '../common/dataAnalysis.vue';
import Advertise from '../common/Advertise.vue';
